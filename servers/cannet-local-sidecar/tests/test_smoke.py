...
def test_package_imports() -> None:
    import cannet_local_sidecar  # noqa: F401

    assert cannet_local_sidecar.__version__
...
def test_driver_zero_interfaces_when_no_hardware() -> None:
    ...
    from cannet_local_sidecar import driver_python_can
...
def test_load_driver_resolves_default_module() -> None:
    from cannet_local_sidecar import server
