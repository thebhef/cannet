...
from cannet_local_sidecar import __main__ as entry  # noqa: E402
...
def test_flag_creates_the_file_and_records_debug_while_stderr_stays_quiet(
    ...
    log = logging.getLogger("cannet_local_sidecar.test")
...
def test_pcan_per_frame_debug_records_are_capped_out_of_the_file(
    ...
    other_log = logging.getLogger("cannet_local_sidecar.test")
