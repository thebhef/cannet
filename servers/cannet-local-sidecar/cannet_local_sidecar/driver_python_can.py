"""Default :mod:`cannet_local_sidecar.driver` implementation, backed by
``python-can``.
...
class PythonCanChannel:
    ...
    def _pcan_state(self) -> ControllerState:
        ...
        **The status word is a floor, not the answer.** Measured on a
        ...
        The two are combined with :func:`~cannet_local_sidecar.driver
    ...
    def _vector_state(self) -> ControllerState:
        ...
        **Unverified against hardware.** No Vector adapter and no Vector
        ...
        (:func:`~cannet_local_sidecar.driver.state_from_counters` combined
        with :func:`~cannet_local_sidecar.driver.worse_state`) rather than a
