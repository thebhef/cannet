...
use ipc::{
    BusFps, DecimatedRange, InterfaceRecord, LogFinished, RemoteSessionResult, SampledPoints,
    SignalExtent, SignalQuery, TraceGrew,
};
...
use trace_query::{
    collect_trace_records, fetch_by_id_page, fetch_filtered_trace, fetch_signal_page,
    fetch_trace_range, filtered_positions_at_ns, frame_indices_at_ns,
};
#[cfg(test)]
use trace_query::{
    apply_filter_records, decode_candidate_ids, fetch_signal_page_inner, sort_by_id,
    windowed_filter_page, ActiveFilterIndex,
};
