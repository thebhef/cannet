...
export interface Settings {
  ...
  /// Which color theme the app renders in — a {@link ThemeName},
  /// verbatim. Applied live: `themeSync.ts` writes it straight to the
  /// `data-theme` attribute the token layer keys off.
  theme: ThemeName;
