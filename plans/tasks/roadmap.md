...
1. [Task 79 — Restore-Then-Import + Scratch Isolation](0079-restore-then-import.md)
   ...
   2026-08-19.
2. [Task 80 — Plot Resample Churn Over a Stopped Capture](0080-stopped-capture-resample.md)
...
3. [Task 82 — Engine-Native Resource Monitoring](0082-engine-native-resource-monitoring.md)
...
4. [Task 83 — Follow-Ups from the 70–78 Cycle](0083-cycle-follow-ups.md)
...
5. [Task 84 — Make the MDF's Embedded DBC Durable](0084-mdf-embedded-dbc.md)
...
6. [Task 77 — Catch-Up Decode Off the Serve Path](0077-background-catchup-decode.md)
