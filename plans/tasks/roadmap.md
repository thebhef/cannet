...
28. [Task 136 — python-can Cannet Client](0136-python-can-cannet-client.md)
    — a Python library using python-can abstractions for a cannet
    client, to integrate cannet into stafl Python apps. Split out of
    task 134, 2026-09-05; **needs grooming**.
29. [Task 137 — Log Export](0137-log-export.md)
    — log export with date/time in the file name; prototype the file
    export dialog's format-string behaviour. Split out of task 134,
    2026-09-05; **needs grooming**.
