...
5. [Task 90 — Follow-Ups from the 86 / 27 / 87 Cycle](0090-cycle-86-87-follow-ups.md)
   ...
   2026-08-19.
6. [Task 89 — The Signal Mapping Panel](0089-signal-mapping-panel.md)
...
7. [Task 91 — `frame_index_at_ns` Binary-Searches an Unsorted Store](0091-frame-index-at-ns-unsorted.md)
...
8. [Task 92 — One Resolution Rule, Not Eleven Copies](0092-one-resolution-rule.md)
   ...
   2026-08-20.
9. [Task 93 — Source Comments Name Task Numbers](0093-source-comments-name-tasks.md)
...
10. [Task 98 — Signals Render Wrong on a Common Scale](0098-common-scale-wrong.md)
   ...
   usage feedback.
11. [Task 95 — Clicking Grid Content Collapses the Row](0095-grid-content-click-collapses.md)
...
12. [Task 97 — Enum Values Still Appear on Axis Labels](0097-enum-labels-on-axis.md)
   ...
   feedback.
13. [Task 96 — Long Signal and Enum Names Do Not Render](0096-long-names-render.md)
...
14. [Task 94 — Server Defaults and Discovery Reachability](0094-server-defaults-and-discovery.md)
   ...
   usage feedback.
15. [Task 99 — Transmit Controls: One Idiom, One State](0099-transmit-controls.md)
...
16. [Task 100 — Counter / CRC From the DBC Does Not Reach the Fields
   ...
   usage feedback.
17. [Task 105 — A BLF Whose Writer Never Finalized](0105-unfinalized-blf-recovery.md)
...
18. [Task 104 — Real Load Progress, and Cancel That Can Be Found](0104-load-progress-and-cancel.md)
...
19. [Task 103 — Toolbar Buttons Become Status Chips](0103-toolbar-status-chips.md)
   — several things sitting in toolbars are states that occasionally
   want pressing, not commands: the RBS connection and scheduled dots,
   the signal mapping panel's attention badge, the bus health chip.
   Owns the shared chip component and its state vocabulary, prototype
   first, so task 101 consumes a language rather than inventing one.
   Opened by owner instruction 2026-08-20.
20. [Task 102 — The Event Surface: Kinds, Filtering, and Its Own
...
21. [Task 101 — Bus Health: Error Frames, Bus Load, Adapter
...
22. [Task 106 — The Any-Bus Series, and the Sample Order It
    ...
    of task 91's audit.
23. [Task 79 — Restore-Then-Import + Scratch Isolation](0079-restore-then-import.md)
   ...
   2026-08-19.
24. [Task 80 — Plot Resample Churn Over a Stopped
   ...
   ruling 2026-08-15.
25. [Task 82 — Engine-Native Resource Monitoring](0082-engine-native-resource-monitoring.md)
...
26. [Task 83 — Follow-Ups from the 70–78 Cycle](0083-cycle-follow-ups.md)
...
27. [Task 84 — Make the MDF's Embedded DBC Durable](0084-mdf-embedded-dbc.md)
...
28. [Task 77 — Catch-Up Decode Off the Serve Path](0077-background-catchup-decode.md)
...
29. [Task 69 — Extension Architecture](0069-extension-architecture.md)
...
30. [Task 61 — Ingest Perf Round 2](0061-ingest-perf-round-2.md)
   ...
   ruling 2026-08-09.
31. [Task 31 — macOS Integration Issues](0031-macos-integration-issues.md)
...
32. [Task 19 — Argument-Taking Palette Commands](0019-command-palette-goto.md)
...
33. [Task 25 — CAN HW + Virtual-Bus Bug Fixes](0025-can-hw-vbus-bugfixes.md)
...
35. [Task 23 — Plot Measurements and Triggers](0023-plot-measurements-and-triggers.md)
   — triggers, math channels, per-series offset / gain, export.
   (Drag-a-plot-area-between-panels shipped separately, 2026-08-08.)
36. [Task 28 — RBS External Value-Source Binding](0028-rbs-external-value-source.md)
...
37. [Task 39 — Automotive Ethernet Signals](0039-ethernet-signals.md)
...
38. [Task 40 — bridge_client / cannet-client Session-Machinery
