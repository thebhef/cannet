...
5. [Task 45 — Settings-Store Consolidation](0045-settings-store-consolidation.md)
   ...
   rather than needing a retrofit. Task 44's Tiers 0–3 are done.
6. [Task 46 — Settings Framework & View](0046-settings-framework-and-view.md)
