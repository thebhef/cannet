...
as intractable and one ratified with no work left. Each ruling is
recorded in the task file that owns the item (the queue's walked
sections were drained to their sources and deleted 2026-08-26; the full
text survives in that file's git history).
...
1. [Task 121 — The Tool Tells the Truth About the Wire](0121-the-trace-tells-the-truth-about-the-wire.md)
...
2. [Task 125 — The Suite Is Green](0125-the-suite-is-green.md)
...
3. [Task 126 — Test and Example Cleanup](0126-test-and-example-cleanup.md)
   ...
   helpers get a guard test; one clean-machine capture set; the two
   unstable metrics get their ruling on charted evidence before the
   close-out gate), small LFS-carried example files for every demoable
   frontend surface, and the exit-criteria verdicts five tasks never
   received. From queue findings 3.45 and all of § 3F, ruled
   2026-08-26. **Gates the chain close-out.**
...
9. [Task 113 — Is RBS a Grid?](0113-rbs-as-a-grid.md)
   ...
   **No open questions**, no phases yet.
10. [Task 116 — RBS Problems Across Every Configuration](0116-rbs-problems-across-configurations.md)
...
11. [Task 112 — The Signal Reference Registry](0112-signal-reference-registry.md)
...
12. [Task 118 — The `comment-references` Check Leaves CI](0118-comment-references-out-of-ci.md)
...
13. [Task 119 — Example DBCs for the Duplicate-Id Collision](0119-duplicate-id-example-dbcs.md)
...
15. [Task 79 — Restore-Then-Import + Scratch Isolation](0079-restore-then-import.md)
   ...
   2026-08-19.
16. [Task 80 — Plot Resample Churn Over a Stopped Capture](0080-stopped-capture-resample.md)
...
17. [Task 82 — Engine-Native Resource Monitoring](0082-engine-native-resource-monitoring.md)
...
18. [Task 83 — Follow-Ups from the 70–78 Cycle](0083-cycle-follow-ups.md)
...
19. [Task 84 — Make the MDF's Embedded DBC Durable](0084-mdf-embedded-dbc.md)
...
20. [Task 77 — Catch-Up Decode Off the Serve Path](0077-background-catchup-decode.md)
...
21. [Task 69 — Extension Architecture](0069-extension-architecture.md)
...
22. [Task 61 — Ingest Perf Round 2](0061-ingest-perf-round-2.md)
    ...
    ruling 2026-08-09.
23. [Task 31 — macOS Integration Issues](0031-macos-integration-issues.md)
...
24. [Task 25 — CAN HW + Virtual-Bus Bug Fixes](0025-can-hw-vbus-bugfixes.md)
...
26. [Task 23 — Plot Measurements and Triggers](0023-plot-measurements-and-triggers.md)
...
27. [Task 28 — RBS External Value-Source Binding](0028-rbs-external-value-source.md)
...
28. [Task 39 — Automotive Ethernet Signals](0039-ethernet-signals.md)
...
29. [Task 40 — bridge_client / cannet-client Session-Machinery
